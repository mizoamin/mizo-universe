        ...
        return (
          <a
            ...
            style={{
              ...
              alignItems: "center",
              justifyContent: "center",
              width: isSidebar ? "var(--size-icon-lg)" : "var(--size-icon-xl)",
              height: isSidebar ? "var(--size-icon-lg)" : "var(--size-icon-xl)",
          ...
          >
            <svg
              ...
              style={{
                transition: "fill var(--duration-fast) var(--ease-out-cubic)",
              }}
            >
              <path d={link.icon} />
            </svg>
