  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between px-6 pt-6 md:px-10 md:pt-8">
        {/* Exit button */}
        <button
          className="pointer-events-auto flex items-center gap-2 rounded-full border border-white/10 bg-black/40 px-4 py-2 text-[11px] uppercase tracking-[0.3em] text-white/50 backdrop-blur-md transition-all hover:border-white/30 hover:text-white/80 active:scale-95"
        ...
        <div className="relative overflow-hidden text-center" style={{ minHeight: "7rem" }}>
          <AnimatePresence mode="wait" custom={direction}>
            ...
            >
              {/* Tagline */}
              <span
                className="text-[10px] uppercase tracking-[0.45em] font-mono"
                style={{ color: rimColor, opacity: 0.7 }}
              >
                {planet?.ui.title ?? ""}
              </span>
              ...
              <h2
                className="text-5xl font-bold uppercase tracking-tight text-white md:text-7xl"
                style={{
              ...
              {/* Description */}
              <p
                className="max-w-xs text-center text-xs leading-relaxed text-white/40 md:max-w-sm md:text-sm"
              >
