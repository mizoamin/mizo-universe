// notifySelfEvolutionResults.cjs
// CommonJS bridge for self-evolution notification in an ESM project.
...
async function main() {
  const { SelfEvolutionEngine } = await import('../agents/SelfEvolutionEngine.js');
