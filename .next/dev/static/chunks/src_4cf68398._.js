 ...
 * ─────────────────────────────────────────────────────────────────
 *   diffuse:    /textures/planets/odyssey/default/diffuse.webp
 *   normal:     /textures/planets/odyssey/default/normal.webp
 *   roughness:  /textures/planets/odyssey/default/roughness.webp
 *   clouds:     /textures/planets/odyssey/default/clouds.webp
 *   night:      /textures/planets/odyssey/default/night.webp
...
const TEXTURES = {
    /** 8K Diffuse (albedo) — full-colour Earth surface */ diffuse: "/textures/planets/odyssey/default/diffuse.webp",
    /** 8K Normal map — terrain elevation → deep topographic shadows */ normal: "/textures/planets/odyssey/default/normal.webp",
    /** 8K Roughness map — oceans smooth, land rough */ roughness: "/textures/planets/odyssey/default/roughness.webp",
    /** 8K Cloud layer — semi-transparent white (used as map + alphaMap) */ clouds: "/textures/planets/odyssey/default/clouds.webp",
    /** 8K Night lights emissiveMap — city lights white-on-black */ night: "/textures/planets/odyssey/default/night.webp"
};
...
function clusterGeoAssets(assets) {
    const clusters = [];
    const used = new Set();
    ...
    // Sort by size descending, cap at MAX_MARKERS
    clusters.sort((a, b)=>b.assets.length - a.assets.length);
    return clusters.slice(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$3d$2f$planets$2f$OdysseyPlanet$2f$skins$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MAX_MARKERS"]);
}
// ─── Manifest Hook — Fetches & Geo-locates Assets ────────────────────────────
function useOdysseyAssets() {
    _s();
            ...
            ({
                "useOdysseyAssets.useEffect": async ()=>{
                    try {
                        ...
                        if (!cancelled) {
                            const clustered = clusterGeoAssets(geoAssets);
 ...
 *  Returns null if the texture fails to load (graceful fallback). */ function useEarthTextures(gl) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useEarthTextures.useEffect": ()=>{
            ...
            const promises = [
                loader.loadAsync(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$3d$2f$planets$2f$OdysseyPlanet$2f$skins$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TEXTURES"].diffuse).then({
                    "useEarthTextures.useEffect": (t)=>configure(t, true)
                }["useEarthTextures.useEffect"]).catch({
                    "useEarthTextures.useEffect": ()=>null
                }["useEarthTextures.useEffect"]),
                loader.loadAsync(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$3d$2f$planets$2f$OdysseyPlanet$2f$skins$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TEXTURES"].normal).then({
                    "useEarthTextures.useEffect": (t)=>configure(t, false)
                }["useEarthTextures.useEffect"]).catch({
                    "useEarthTextures.useEffect": ()=>null
                }["useEarthTextures.useEffect"]),
                loader.loadAsync(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$3d$2f$planets$2f$OdysseyPlanet$2f$skins$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TEXTURES"].roughness).then({
                    "useEarthTextures.useEffect": (t)=>configure(t, false)
                }["useEarthTextures.useEffect"]).catch({
                    "useEarthTextures.useEffect": ()=>null
                }["useEarthTextures.useEffect"]),
                loader.loadAsync(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$3d$2f$planets$2f$OdysseyPlanet$2f$skins$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TEXTURES"].clouds).then({
                    "useEarthTextures.useEffect": (t)=>configure(t, true)
                }["useEarthTextures.useEffect"]).catch({
                    "useEarthTextures.useEffect": ()=>null
                }["useEarthTextures.useEffect"]),
                loader.loadAsync(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$3d$2f$planets$2f$OdysseyPlanet$2f$skins$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TEXTURES"].night).then({
                    "useEarthTextures.useEffect": (t)=>configure(t, false)
                }["useEarthTextures.useEffect"]).catch({
                    "useEarthTextures.useEffect": ()=>null
                }["useEarthTextures.useEffect"])
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$drei$2f$core$2f$shapes$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Sphere"], {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("meshPhysicalMaterial", {
                    ...
                    ...diffuse ? {
                        ...
                        color: new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Color"](__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$3d$2f$planets$2f$OdysseyPlanet$2f$skins$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PALETTE"].ocean)
                    },
                    ...normal ? {
                        normalMap: normal
                    } : {},
...
_s2(EarthGlobe, "35BpQClsYn0WjAOjLc0gVU1xTqg=", false, function() {
    return [
...
_s3(AtmosphericGlow, "JN+ma1M3Yo0s+NkpTM7NTJyhuuw=");
_c1 = AtmosphericGlow;
// ─── Lighting Rig ─────────────────────────────────────────────────────────────
...
function OdysseyPins({ clusters, onPinHover, onPinClick }) {
    _s4();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$fiber$2f$dist$2f$events$2d$5a94e5eb$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__D__as__useFrame$3e$__["useFrame"])({
        "OdysseyPins.useFrame": ({ clock }, delta)=>{
            ...
            for(let i = 0; i < clusters.length; i++){
                ...
                if (dist > __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$3d$2f$planets$2f$OdysseyPlanet$2f$skins$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LOD_CULL_RADIUS"]) {
                    _dummy.scale.setScalar(0);
                    _dummy.updateMatrix();
                    mesh.setMatrixAt(i, _dummy.matrix);
                }
                // Update emissive per hover
                _tempColor.set(isHovered ? new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Color"](__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$3d$2f$planets$2f$OdysseyPlanet$2f$skins$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PALETTE"].pinWhite) : c.isMega ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$3d$2f$planets$2f$OdysseyPlanet$2f$skins$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PIN"].megaColor : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$3d$2f$planets$2f$OdysseyPlanet$2f$skins$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PIN"].color);
                mesh.setColorAt(i, _tempColor);
            }
            mesh.instanceMatrix.needsUpdate = true;
            if (mesh.instanceColor) mesh.instanceColor.needsUpdate = true;
...
_c4 = HoloTooltip;
function TravelLog({ clusters, onFlyTo }) {
    _s5();
    ...
    const topCities = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TravelLog.useMemo[topCities]": ()=>{
            ...
            }["TravelLog.useMemo[topCities]"]).slice(0, 20);
        }
    }["TravelLog.useMemo[topCities]"], [
        clusters
    ]);
...
_c5 = TravelLog;
function ClusterPanel({ cluster, visible, onClose, onSelectAsset }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$drei$2f$web$2f$Html$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Html"], {
        center: true,
        style: {
            pointerEvents: "none",
            ...
            children: visible && cluster && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: cluster.assets.slice(0, 50).map((asset)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
function OdysseyPlanetVisual() {
    ...
    const { clusters, totalCount, loading } = useOdysseyAssets();
...
_s6(OdysseyPlanetVisual, "chsIuj6RnMYNGV1v168BgG7Fgb4=", false, function() {
    return [
        useOdysseyAssets
    ];
});
...
//# sourceMappingURL=src_4cf68398._.js.map