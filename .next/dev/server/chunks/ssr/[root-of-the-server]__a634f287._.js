...
"[project]/src/components/ui/widgets/VoiceSignalGrid.tsx [app-rsc] (client reference proxy) <module evaluation>", ((__turbopack_context__) => {
"use strict";
...
;
const __TURBOPACK__default__export__ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerClientReference"])(function() {
    throw new Error("Attempted to call the default export of [project]/src/components/ui/widgets/VoiceSignalGrid.tsx <module evaluation> from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
}, "[project]/src/components/ui/widgets/VoiceSignalGrid.tsx <module evaluation>", "default");
}),
"[project]/src/components/ui/widgets/VoiceSignalGrid.tsx [app-rsc] (client reference proxy)", ((__turbopack_context__) => {
"use strict";
...
;
const __TURBOPACK__default__export__ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerClientReference"])(function() {
    throw new Error("Attempted to call the default export of [project]/src/components/ui/widgets/VoiceSignalGrid.tsx from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
}, "[project]/src/components/ui/widgets/VoiceSignalGrid.tsx", "default");
}),
"[project]/src/components/ui/widgets/VoiceSignalGrid.tsx [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$widgets$2f$VoiceSignalGrid$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/src/components/ui/widgets/VoiceSignalGrid.tsx [app-rsc] (client reference proxy) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$widgets$2f$VoiceSignalGrid$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__ = __turbopack_context__.i("[project]/src/components/ui/widgets/VoiceSignalGrid.tsx [app-rsc] (client reference proxy)");
;
__turbopack_context__.n(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$widgets$2f$VoiceSignalGrid$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__);
}),
...
"[project]/src/data/hostinger-registry/assetHelper.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ /** Hostinger CDN root (no trailing slash). */ __turbopack_context__.s([
    "HOSTINGER_CDN_BASE",
    ()=>HOSTINGER_CDN_BASE,
    "getAssetUrl",
    ()=>getAssetUrl
]);
const HOSTINGER_CDN_BASE = process.env.NEXT_PUBLIC_ASSET_ROOT ?? "https://mizoamin.com/wp-content/uploads/mizo_final_assets/mizo_production_assets";
function getAssetUrl(relativePath) {
    // Reject paths that try to escape the CDN root
    const sanitized = relativePath.replace(/^\/+/, '');
    if (sanitized.includes('..')) {
        throw new Error(`Invalid asset path: "${relativePath}". Path traversal is not allowed.`);
    }
    const base = HOSTINGER_CDN_BASE.replace(/\/+$/, "");
    return `${base}/${sanitized}`;
}
}),
"[project]/src/lib/voiceRegistry.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "getVoiceRegistryData",
    ()=>getVoiceRegistryData
]);
var __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/fs [external] (fs, cjs)");
var __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/path [external] (path, cjs)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$hostinger$2d$registry$2f$assetHelper$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/data/hostinger-registry/assetHelper.ts [app-rsc] (ecmascript)");
;
;
;
const REGISTRY_DIR = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), "src/data/hostinger-registry");
const SEO_FILE = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(REGISTRY_DIR, "seo-v8.txt");
const PLAN_FILE = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(REGISTRY_DIR, "folder_structure_plan.txt");
const MANIFEST_FILE = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(REGISTRY_DIR, "assets_manifest_v8.json");
let cache = null;
...
function parseTaxonomy(planText) {
    const matched = new Set();
    const lines = planText.split(/\r?\n/);
    for (const line of lines){
        if (/interview|podcast|radio|press-conference|media-appearances/i.test(line) && line.includes("[DIR]")) {
    ...
    return Array.from(matched).slice(0, 8).map((en)=>({
            en,
            ar: mapAr[en] ?? "وسائط صوتية"
        }));
}
async function getVoiceRegistryData(limit = 12) {
    if (cache) return cache;
    const [seoText, planText, manifestText] = await Promise.all([
        __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["promises"].readFile(SEO_FILE, "utf8"),
        __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["promises"].readFile(PLAN_FILE, "utf8"),
        __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["promises"].readFile(MANIFEST_FILE, "utf8")
    ]);
    ...
    for (const block of blocks){
        ...
        const sourceDir = normalizeManifestPath(pathFromManifest).split("/").slice(0, -1).join("/");
        ...
        items.push({
            ...
            titleEn,
            titleAr,
            imageUrl: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$hostinger$2d$registry$2f$assetHelper$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getAssetUrl"])(normalizeManifestPath(pathFromManifest)),
            sourceDir
        });
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$widgets$2f$VoiceSignalGrid$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ui/widgets/VoiceSignalGrid.tsx [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$voiceRegistry$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/voiceRegistry.ts [app-rsc] (ecmascript)");
;
;
;
;
const metadata = {
    title: "VOICE SIGNALS — Podcasts & Interviews",
    description: "The Voice node of Mizo Universe: podcasts, interviews, and audio-note transmissions extracted from the Hostinger registry and mapped into a hybrid media gallery.",
    openGraph: {
        title: "VOICE SIGNALS — Mizo Amin",
        description: "Podcasts, interviews, and spoken transmissions from the Mizo Universe communication frequency.",
        type: "website"
    }
};
async function VoicePage() {
    const payload = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$voiceRegistry$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getVoiceRegistryData"])(12);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$layout$2f$PlanetPageLayout$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"], {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "mb-10 rounded-2xl border border-white/10 bg-white/[0.02] p-6 md:p-8 overflow-hidden relative",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "absolute inset-0 pointer-events-none bg-[radial-gradient(circle_at_20%_40%,rgba(255,0,128,0.25),transparent_50%),radial-gradient(circle_at_80%_70%,rgba(255,79,166,0.2),transparent_45%)]"
                    }, void 0, false, {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-xs uppercase tracking-[4px] text-pink-400 mb-3",
                                children: "Sonic Pulse Engine"
                            }, void 0, false, {
                                fileName: "[project]/src/app/voice/page.tsx",
                                lineNumber: 26,
                                columnNumber: 11
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                ...
                                children: "Podcast & Interview Frequency"
                            }, void 0, false, {
                                fileName: "[project]/src/app/voice/page.tsx",
                                lineNumber: 27,
                                columnNumber: 11
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: "Hybrid registry mode is active. Voice metadata is parsed from Hostinger intelligence files and projected as a signal archive. Every card is a recoverable media transmission with bilingual context."
                            }, void 0, false, {
                                fileName: "[project]/src/app/voice/page.tsx",
                                lineNumber: 30,
                                columnNumber: 11
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$widgets$2f$VoiceSignalGrid$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"], {
                accentColor: "#ff0080",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a634f287._.js.map